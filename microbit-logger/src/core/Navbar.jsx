        ...
        <>
            {adaptive ? (<div id='navbar'>
                <div style={{display: 'flex', alignItems: 'center', fontSize: '25px', width: '50%'}}>
                    <div style={{width: '80px', height: '80px',  marginRight: '2%'}}><img src={icon} style={{width: '5rem', height: '5rem'}}/></div>
                ...
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'flex-end', width: '50%'}}>
                    {microbits.length > 0 && <Button onClick={onConnectClicked} variant='primary' size="lg" style={{width: '8rem', height: '4rem', marginRight: '1rem'}}>Connect</Button>}
                ...
                <div id='navbar'>
                    <div style={{display: 'flex', alignItems: 'center', fontSize: '25px', width: '100%'}}>
                        <div style={{display: 'flex', justifyContent: 'space-around', width: '100%'}}>
                            ...
                            </> : <Button onClick={onConnectClicked} variant='primary' size="lg" style={{width: '10rem', height: '4rem', fontSize: '1.5rem'}}>Connect</Button>}
                        </div>
                    </div>
                </div>
            </>
